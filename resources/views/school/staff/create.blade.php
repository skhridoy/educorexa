        ...
        <div class="page-header-card mb-4">
            <div class="page-header-content">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h1 class="page-title text-white">Register New Staff</h1>
                        <p class="page-subtitle text-white-50">Onboard a new non-teaching professional to your team</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-10 col-xl-9">
                <div class="card glass-card border-0 shadow-lg overflow-hidden mb-5" style="border-radius: 24px;">
                    <div class="card-header bg-primary bg-opacity-10 border-0 p-4">
                        <h5 class="mb-0 fw-bold text-primary"><i class="fa-solid fa-id-card me-2"></i> Staff Profile Details</h5>
                    </div>
                    <div class="card-body p-4 p-md-5">
                        <form method="POST" action="{{ route('staff.store', ['tenant' => auth()->user()?->school?->slug]) }}" enctype="multipart/form-data" class="modern-form">
                            @csrf
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-12 text-center mb-4">
                                    <div class="d-inline-block position-relative">
                                        <div id="photo-preview-container" onclick="document.getElementById('imageInput').click();">
                                            <img id="mainProfilePic" src="{{ asset('assets/images/profile.webp') }}" alt="Preview">
                                        </div>
                                    ...
                                    <h6 class="mt-3 fw-bold text-dark mb-1">Staff Member Photo</h6>
                                    <p class="small text-muted mb-0">Recommended: Square image, max 2MB</p>
                                    ...
                                    <div class="form-group modern-input-group">
                                        ...
                                        <div class="input-group-custom shadow-sm rounded-3 overflow-hidden d-flex">
                                            ...
                                            <input type="email" name="email" class="form-control border-0 py-2 fs-6 bg-white" id="email" 
                                                   placeholder="staff@institution.com" value="{{ old('email') }}" required>
                                        </div>
                                        @error('email')
                                            <p class="text-danger small mt-1 animate__animated animate__headShake">{{ $message }}</p>
                                        @enderror
                                ...
                                <div class="col-12 mt-4">
                                    <h5 class="form-section-title"><i class="fa-solid fa-lock me-2 text-primary"></i> Security & Access</h5>
                                </div>

                                <div class="col-md-6">
                                    <div class="form-group modern-input-group">
                                        <label class="form-label text-dark fw-semibold" for="password">Login Password <span class="text-danger">*</span></label>
                                        <div class="input-group-custom shadow-sm rounded-3 overflow-hidden d-flex">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group modern-input-group">
                                        <label class="form-label text-dark fw-semibold" for="password_confirmation">Confirm Password <span class="text-danger">*</span></label>
                                        <div class="input-group-custom shadow-sm rounded-3 overflow-hidden d-flex">
                                ...
                                <div class="col-12 mt-5">
                                    <div class="p-4 bg-light rounded-4 border-start border-4 border-primary shadow-sm">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                                            <div>
                                                <h6 class="fw-bold mb-1">Confirm Staff Registration</h6>
                                                <p class="small text-muted mb-0">Please verify all information before finalizing the registration.</p>
                                            </div>
                                            <div class="d-flex gap-3">
                                                ...
                                                <button type="submit" class="btn btn-primary-gradient rounded-pill shadow">
                                                    <i class="fa-solid fa-paper-plane me-2"></i> Register Member
                                                </button>
                                            </div>
                                        </div>
                                    </div>
