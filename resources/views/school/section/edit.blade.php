            ...
            <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h6 class="card-title">Update Section</h6>
                        <form action="{{ route('sections.update', ['tenant' => auth()->user()->school->slug,'section' => $section->id]) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="mb-3">
                                <label for="name" class="form-label">Name</label>
                                <input type="text" class="form-control" id="name" name="name" value="{{ old('name', $section->name) }}" placeholder="Enter Section Name: [A, ...]" required>
                            </div>
                            <div class="mb-3">
