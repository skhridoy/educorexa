    ...
    <div class="container-fluid">
        ...
        <div class="page-header-card mb-4">
            <div class="page-header-content">
                <h1 class="page-title"><i class="fa-solid fa-building-circle-gear me-2"></i> School Settings</h1>
                <p style="margin: 0; opacity: 0.85;">Update and manage your institution's profile and credentials</p>
            </div>
        </div>
                ...
                <div class="form-card">
                    <form action="{{ route('admin.school.info-update', ['tenant' => auth()->user()->school->slug]) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row g-4">
                            {{-- Basic Info --}}
                            <div class="col-md-6">
                                <label class="form-label"><i class="fa-solid fa-school me-2 text-primary opacity-50"></i> School's Name</label>
                                <input type="text" name="name" class="form-control" value="{{ $school->name }}" placeholder="Institutional Name">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label"><i class="fa-solid fa-fingerprint me-2 text-primary opacity-50"></i> EIN Number</label>
                                <input type="text" name="ein_number" class="form-control" value="{{ $school->ein_number }}" placeholder="Institution EIN">
                            </div>
                            
                            <div class="col-md-6">
                                <label class="form-label"><i class="fa-solid fa-code me-2 text-primary opacity-50"></i> EMIS Code</label>
                            ...
                            <div class="col-md-6">
                                <label class="form-label"><i class="fa-solid fa-phone me-2 text-primary opacity-50"></i> Phone Number</label>
                            ...
                            {{-- Assets --}}
                            <div class="col-md-6">
                                <label class="form-label"><i class="fa-solid fa-image me-2 text-primary opacity-50"></i> School Logo</label>
                            ...
                            <div class="col-md-6">
                                <label class="form-label"><i class="fa-solid fa-icons me-2 text-primary opacity-50"></i> Favicon (32x32)</label>
                            ...
                            <div class="col-md-12">
                                <label class="form-label"><i class="fa-solid fa-location-dot me-2 text-primary opacity-50"></i> Institutional Address</label>
