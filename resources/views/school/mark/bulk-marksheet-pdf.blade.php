...
<head>
    <meta charset="UTF-8">
    <title>Bulk Marksheets - {{ $class->name }} ({{ $exam->name }})</title>
    <style>
        @page {
...
@php
    ...
    $displayRoll          = $sheet['displayRoll'];
    $displayCustomId      = $sheet['displayCustomId'];
    $marksData            = $sheet['marksData'];
    $totalMarks           = $sheet['totalMarks'];
    $numericGpa           = $sheet['numericGpa'];
    $finalGrade           = $sheet['finalGrade'];
    $meritPosition        = $sheet['meritPosition'];
    $formattedDOB         = $sheet['formattedDOB'];
