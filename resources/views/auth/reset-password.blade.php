                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 ps-md-0">
                                <div class="auth-form-wrapper px-4 py-5">
                                    ...
                                    <h5 class="text-muted fw-normal mb-4">Reset your password to regain access.</h5>
                                    ...
                                    <form class="forms-sample" action="{{ route('password.update') }}" method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="password" name="password" class="form-control @error('password') is-invalid @enderror" id="userPassword" placeholder="New Password" required>
                                            @error('password')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="password" name="password_confirmation" class="form-control" id="userPasswordConfirm" placeholder="Confirm Password" required>
                                        </div>

                                        <div>
                                            <button type="submit" class="btn btn-primary me-2 mb-2 mb-md-0 text-white w-100">Reset Password</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
