        ...
        <ul class="edu-nav">
            ...
            <li class="edu-nav-item">
                <a class="edu-nav-link edu-has-submenu {{ Request::is('*/academic*') || Request::is('*/classes*') || Request::is('*/sections*') || Request::is('*/subjects*') || Request::is('*/routine*') ? 'active' : '' }}" 
                   ...
                   aria-expanded="{{ Request::is('*/academic*') || Request::is('*/classes*') || Request::is('*/sections*') || Request::is('*/subjects*') || Request::is('*/routine*') ? 'true' : 'false' }}">
                ...
                <div class="collapse {{ Request::is('*/academic*') || Request::is('*/classes*') || Request::is('*/sections*') || Request::is('*/subjects*') || Request::is('*/routine*') ? 'show' : '' }}" id="academicMenu">
                    <ul class="edu-sub-nav">
                        ...
                        <li class="edu-sub-item"><a href="{{ route('subjects.index', ['tenant' => $tenant]) }}" class="edu-sub-link {{ Request::is('*/subjects*') ? 'active' : '' }}">Subjects</a></li>
                        @endif
                        @if(in_array('assign.subject', $permissions))
                        <li class="edu-sub-item"><a href="{{ route('subjects.assign', ['tenant' => $tenant]) }}" class="edu-sub-link {{ Request::is('*/subjects/assign*') ? 'active' : '' }}">Assign Subject</a></li>
                        @endif
            ...
            <li class="edu-nav-item">
                <a class="edu-nav-link edu-has-submenu {{ Request::is('*/students*') || Request::is('*/admissions*') ? 'active' : '' }}" 
                   data-bs-toggle="collapse" href="#studentMenu" role="button"
                   aria-expanded="{{ Request::is('*/students*') || Request::is('*/admissions*') ? 'true' : 'false' }}">
                ...
                <div class="collapse {{ Request::is('*/students*') || Request::is('*/admissions*') ? 'show' : '' }}" id="studentMenu">
                    <ul class="edu-sub-nav">
                        ...
                        <li class="edu-sub-item"><a href="{{ route('students.index', ['tenant' => $tenant]) }}" class="edu-sub-link {{ Request::is('*/students') ? 'active' : '' }}">Student List</a></li>
                        ...
                        <li class="edu-sub-item"><a href="{{ route('students.idcard.index', ['tenant' => $tenant]) }}" class="edu-sub-link {{ Request::is('*/students/idcard*') ? 'active' : '' }}">Generate ID Cards</a></li>
                        @endif
                        @if(in_array('student.promotion', $permissions))
                        <li class="edu-sub-item"><a href="{{ route('students.promotion', ['tenant' => $tenant]) }}" class="edu-sub-link {{ Request::is('*/students/promotion*') ? 'active' : '' }}">Promotion</a></li>
                        @endif
                    </ul>
                </div>
            </li>
            ...
            <li class="edu-nav-item">
                <a class="edu-nav-link edu-has-submenu {{ Request::is('*/teachers*') ? 'active' : '' }}" 
                ...
                <div class="collapse {{ Request::is('*/teachers*') ? 'show' : '' }}" id="teacherMenu">
                    <ul class="edu-sub-nav">
                        ...
                        <li class="edu-sub-item"><a href="{{ route('teacher.assign', ['tenant' => $tenant]) }}" class="edu-sub-link {{ Request::is('*/teachers/assign*') ? 'active' : '' }}">Assign Teacher</a></li>
                        @endif
                    </ul>
                </div>
            </li>
            ...
            <li class="edu-nav-item">
                <a class="edu-nav-link edu-has-submenu {{ Request::is('*/attendances*') || Request::is('*/exams*') || Request::is('*/marks*') ? 'active' : '' }}" 
                   data-bs-toggle="collapse" href="#attendanceExamMenu" role="button"
                   aria-expanded="{{ Request::is('*/attendances*') || Request::is('*/exams*') || Request::is('*/marks*') ? 'true' : 'false' }}">
                ...
                <div class="collapse {{ Request::is('*/attendances*') || Request::is('*/exams*') || Request::is('*/marks*') ? 'show' : '' }}" id="attendanceExamMenu">
                    <ul class="edu-sub-nav">
                        ...
                        <li class="edu-sub-item"><a href="{{ route('attendances.index', ['tenant' => $tenant]) }}" class="edu-sub-link {{ Request::is('*/attendances') ? 'active' : '' }}">Take Attendance</a></li>
                        @endif
                        @if(in_array('attendance.report', $permissions) || $user->hasRole('school_admin'))
                        <li class="edu-sub-item"><a href="{{ route('student.attendance.report', ['tenant' => $tenant]) }}" class="edu-sub-link {{ Request::is('*/student/attendance/report*') ? 'active' : '' }}">Attendance Report</a></li>
                        @endif
                        @if(in_array('holiday.manage', $permissions))
                        <li class="edu-sub-item"><a href="{{ route('holidays.index', ['tenant' => $tenant]) }}" class="edu-sub-link {{ Request::is('*/holidays*') ? 'active' : '' }}">Holiday Setup</a></li>
                        @endif
                        @if(in_array('exam.manage', $permissions))
                        <li class="edu-sub-item"><a href="{{ route('exams.index', ['tenant' => $tenant]) }}" class="edu-sub-link {{ Request::is('*/exams') ? 'active' : '' }}">Manage Exams</a></li>
                        <li class="edu-sub-item"><a href="{{ route('exams.admit-card', ['tenant' => $tenant]) }}" class="edu-sub-link {{ Request::is('*/exams/admit-card*') ? 'active' : '' }}">Admit Cards</a></li>
                        @endif
                        ...
                        <li class="edu-sub-item"><a href="{{ route('marks.view-marks', ['tenant' => $tenant]) }}" class="edu-sub-link {{ Request::is('*/marks/view-marks*') ? 'active' : '' }}">View Results</a></li>
                        @endif
                    </ul>
                </div>
            </li>
            ...
            <li class="edu-nav-item">
                <a class="edu-nav-link edu-has-submenu {{ Request::is('*/diary*') ? 'active' : '' }}" 
                   data-bs-toggle="collapse" href="#diaryMenu" role="button"
                   aria-expanded="{{ Request::is('*/diary*') ? 'true' : 'false' }}">
                ...
                <div class="collapse {{ Request::is('*/diary*') ? 'show' : '' }}" id="diaryMenu">
                    <ul class="edu-sub-nav">
                        @can('lesson.manage')
                        <li class="edu-sub-item"><a href="{{ route('diary.index', ['tenant' => $tenant]) }}" class="edu-sub-link {{ Request::is('*/diary') ? 'active' : '' }}">Daily Entry</a></li>
                        @endcan
                        <li class="edu-sub-item"><a href="{{ route('diary.student_view', ['tenant' => $tenant]) }}" class="edu-sub-link {{ Request::is('*/diary/student_view*') ? 'active' : '' }}">View Diary</a></li>
                    </ul>
                </div>
            </li>
            @endif
            ...
            <li class="edu-nav-item">
                <a class="edu-nav-link edu-has-submenu {{ Request::is('*/fee*') || Request::is('*/payment*') ? 'active' : '' }}" 
                   data-bs-toggle="collapse" href="#feeMenu" role="button"
                   aria-expanded="{{ Request::is('*/fee*') || Request::is('*/payment*') ? 'true' : 'false' }}">
                ...
                <div class="collapse {{ Request::is('*/fee*') || Request::is('*/payment*') ? 'show' : '' }}" id="feeMenu">
                    <ul class="edu-sub-nav">
                        ...
                        <li class="edu-sub-item"><a href="{{ route('fee-heads.index', ['tenant' => $tenant]) }}" class="edu-sub-link {{ Request::is('*/fee-heads*') ? 'active' : '' }}">Fee Heads</a></li>
                        <li class="edu-sub-item"><a href="{{ route('fee-amounts.index', ['tenant' => $tenant]) }}" class="edu-sub-link {{ Request::is('*/fee-amounts*') ? 'active' : '' }}">Fee Amounts</a></li>
                        <li class="edu-sub-item"><a href="{{ route('student-fees.index', ['tenant' => $tenant]) }}" class="edu-sub-link {{ Request::is('*/fee/student*') ? 'active' : '' }}">Fees Generation</a></li>
                        @endif
                        @if(in_array('fee.collect', $permissions))
                        <li class="edu-sub-item"><a href="{{ route('payment.index', ['tenant' => $tenant]) }}" class="edu-sub-link {{ Request::is('*/payment*') ? 'active' : '' }}">Collect Payment</a></li>
                        @endif
                    </ul>
                </div>
            </li>
            ...
            <li class="edu-nav-item">
                <a class="edu-nav-link edu-has-submenu {{ Request::is('*/notices*') || Request::is('*/sliders*') || Request::is('*/about*') || Request::is('*/footer*') ? 'active' : '' }}" 
                   data-bs-toggle="collapse" href="#webMenu" role="button"
                   aria-expanded="{{ Request::is('*/notices*') || Request::is('*/sliders*') || Request::is('*/about*') || Request::is('*/footer*') ? 'true' : 'false' }}">
                ...
                <div class="collapse {{ Request::is('*/notices*') || Request::is('*/sliders*') || Request::is('*/about*') || Request::is('*/footer*') ? 'show' : '' }}" id="webMenu">
                    <ul class="edu-sub-nav">
                        ...
                        <li class="edu-sub-item"><a href="{{ route('notices.index', ['tenant' => $tenant]) }}" class="edu-sub-link {{ Request::is('*/notices*') ? 'active' : '' }}">Notice Board</a></li>
                        <li class="edu-sub-item"><a href="{{ route('admin.messages.index', ['tenant' => $tenant]) }}" class="edu-sub-link {{ Request::is('*/admin/messages*') ? 'active' : '' }}">Contact Messages</a></li>
                        @endif
                        @if(in_array('slider.manage', $permissions) || in_array('system.settings', $permissions))
                        <li class="edu-sub-item"><a href="{{ route('sliders.index', ['tenant' => $tenant]) }}" class="edu-sub-link {{ Request::is('*/sliders*') ? 'active' : '' }}">Sliders</a></li>
                        <li class="edu-sub-item"><a href="{{ route('about.index', ['tenant' => $tenant]) }}" class="edu-sub-link {{ Request::is('*/about*') ? 'active' : '' }}">About Content</a></li>
                        <li class="edu-sub-item"><a href="{{ route('footer.edit', ['tenant' => $tenant]) }}" class="edu-sub-link {{ Request::is('*/footer*') ? 'active' : '' }}">Footer Settings</a></li>
                        @endif
                    </ul>
                </div>
            </li>
