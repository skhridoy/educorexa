...
<div class="page-content">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            <h2 class="edu-page-title"><i class="fa-solid fa-plus-circle me-2" style="color:#4f46e5;"></i> Add Blog Category</h2>
            <p class="edu-page-sub">Create a new category to group your educational posts.</p>
        </div>
    </div>
    ...
    <div class="edu-panel">
        ...
        <div class="edu-panel-bd">
            <form action="{{ route('super.blog-categories.store') }}" method="POST">
                @csrf
                <div class="row g-4">
                    <div class="col-md-6">
                        <label class="edu-label">Category Name <span class="text-danger">*</span></label>
                        <input type="text" name="name" id="categoryName" class="form-control edu-input" placeholder="e.g. শিক্ষা প্রযুক্তি (EdTech) or Tips/Guides" value="{{ old('name') }}" required>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="slug" id="categorySlug" class="form-control edu-input" placeholder="auto-generated-slug" value="{{ old('slug') }}">
                        </div>
                    ...
                    <div class="col-12 d-flex justify-content-end gap-2">
                        ...
                        <button type="submit" class="btn-edu btn-edu-primary" style="padding:12px 40px;">
                            <i data-feather="check-circle" style="width:16px; margin-right:5px;"></i> Save Category
                        </button>
                    </div>
                </div>
            </form>
