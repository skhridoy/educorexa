                                ...
                                <div class="row g-2">
                                    <div class="col-6">
                                        ...
                                        <select name="commission_type" class="form-select" style="border-radius:10px;border-color:#e2e8f0;font-size:0.85rem;padding:8px 12px;">
                                            <option value="flat" {{ old('commission_type', $employee->employee->commission_type ?? 'flat') == 'flat' ? 'selected' : '' }}>ফ্ল্যাট (৳ টাকা)</option>
                                            <option value="percentage" {{ old('commission_type', $employee->employee->commission_type ?? '') == 'percentage' ? 'selected' : '' }}>শতাংশ (% পারসেন্টেজ)</option>
                                        </select>
                                    </div>
                                    <div class="col-6">
                                        <label class="form-label" style="font-size:0.8rem;font-weight:600;color:#374151;">কমিশন রেট</label>
                                        <input type="number" step="0.01" min="0" name="commission_rate" class="form-control" placeholder="0.00"
                                               value="{{ old('commission_rate', $employee->employee->commission_rate ?? '0.00') }}"
                                ...
                                <div class="row g-2">
                                    <div class="col-6">
                                        ...
                                        <select name="monthly_commission_type" class="form-select" style="border-radius:10px;border-color:#e2e8f0;font-size:0.85rem;padding:8px 12px;">
                                            <option value="flat" {{ old('monthly_commission_type', $employee->employee->monthly_commission_type ?? 'flat') == 'flat' ? 'selected' : '' }}>ফ্ল্যাট (৳ টাকা)</option>
                                            <option value="percentage" {{ old('monthly_commission_type', $employee->employee->monthly_commission_type ?? '') == 'percentage' ? 'selected' : '' }}>শতাংশ (% পারসেন্টেজ)</option>
                                        </select>
                                    </div>
                                    <div class="col-6">
                                        <label class="form-label" style="font-size:0.8rem;font-weight:600;color:#374151;">কমিশন রেট</label>
                                        <input type="number" step="0.01" min="0" name="monthly_commission_rate" class="form-control" placeholder="0.00"
                                               value="{{ old('monthly_commission_rate', $employee->employee->monthly_commission_rate ?? '0.00') }}"
                                               style="border-radius:10px;border-color:#e2e8f0;font-size:0.85rem;padding:8px 12px;">
                                    </div>
                                </div>
                            </div>
